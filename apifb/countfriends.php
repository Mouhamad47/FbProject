...
$query = "Select COUNT(u.id) as number_of_friends from users u, connections c where (c.second_user_id = u.id AND c.first_user_id = ? AND c.blocked = ? AND u.id <> ? AND c.is_pending = ?)
